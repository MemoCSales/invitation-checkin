			...
			<div className="grid gap-4 grid-cols-1 md:grid-cols-3">
				...
				<div className="md:col-span-2 flex flex-col space-y-4">
					<div className="flex flex-col gap-y-8">
						...
						<div className="flex flex-row">
							<div className="basis-1/3 text-right font-bold">5:30 p.m.</div>
							<div className="basis-2/3">Peda numero 1</div>
						</div>
						<div className="flex flex-row">
							<div className="basis-1/3 text-right font-bold">6:30 p.m.</div>
							<div className="basis-2/3">Cenar</div>
						</div>
						<div className="flex flex-row">
							<div className="basis-1/3 text-right font-bold">7:30 p.m.</div>
